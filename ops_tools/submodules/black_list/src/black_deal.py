...
class Worker(ConsumerMixin):
    ...
    def send_task_down_high(self, data):
        ...
        gv.statsd_conn.incr("thunder.ops_tools.black_list.send_download_high", 1)
    ...
    def send_task_down_low(self, data):
        ...
        gv.statsd_conn.incr("thunder.ops_tools.black_list.send_download_low", 1)
    ...
    def check_task_blacklist(self, data):
        ...
        if is_keyword:
            gv.g_logger.info("black word match %s"%(file_name))
    ...
    def process_task(self, body, message):
        try:
            ...
            gv.statsd_conn.incr("thunder.ops_tools.black_list.get_download_high_tmp", 1)
