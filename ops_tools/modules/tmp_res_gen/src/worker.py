...
from utils import execute_sql, insert_vddb, should_die, timeit
...
def _do_insert(done_conn, insert_done_sql, record):
    ...
    try:
        ...
        insert_vddb(cfg['vddb-async-url'], [thunder_hash, digest], logger)
